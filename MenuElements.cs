...
namespace SE307Project
{
    class MenuElements
    {
        ...
        private string shopName,name,location,tempPassword,password,ID,description,category,input,deleteID;       
        User user = new User();
        Item item = new Item();
        private bool breakFlag, breakFlag2, breakFlag3, failmessage;
            ...
            while (breakFlag2)
            {
                ...
                switch (Console.ReadLine())
                {
                    case "1":
                        ...
                        //Cannot reach buyer and seller attributes
        ...
        public void addRemoveItems() //Connect the items to their seller with userID  // Try adding category lists into am item list
        {
            breakFlag2 = true;
            while (breakFlag2)
            {
